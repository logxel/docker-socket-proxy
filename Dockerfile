...
LABEL org.opencontainers.image.title="docker-socket-proxy" \
      ...
      org.opencontainers.image.source="https://github.com/grupo-farinter-oss/docker-socket-proxy" \
      org.opencontainers.image.documentation="https://github.com/grupo-farinter-oss/docker-socket-proxy/blob/main/README.md" \
